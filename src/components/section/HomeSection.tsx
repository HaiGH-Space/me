        ...
        <section id="home" className="flex my-6 flex-col-reverse lg:flex-row lg:gap-44 gap-6 md:gap-20 justify-center items-center min-h-screen">
            <div className="text-center lg:text-right">
                ...
                <div className="space-x-2 my-6">
                    <a href={`${import.meta.env.BASE_URL}/Hai-Nguyen-CV.pdf`} target="_blank" rel="noopener noreferrer" className={cn("px-4 py-2", "font-bold border-2 rounded-full hover:scale-105 transition-transform duration-300 hover:shadow-[0_0_25px_0] text-black bg-primary border-none cursor-pointer shadow-[0_0_10px_0] shadow-primary")}>
                        Resume
                    </a>
                    <a href="#contact" className={cn("px-4 py-2", "font-bold border-primary border-2 bg-transparent text-primary rounded-full duration-300 hover:shadow-[0_0_10px_0] hover:text-black hover:bg-primary cursor-pointer shadow-primary")}>
                        Contact
                    </a>
                </div>
            </div>
